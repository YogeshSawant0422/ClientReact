      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div className="col-sm p-3 min-vh-100 CenterLogo" style={{backgroundColor:"#1C8EF9"}}>
            <div class="card">
              <h3 class="card-header">Add New Teacher</h3>
              <div class="card-body">
                      ...
                      <div style={{ padding: "5px" }}>
                        <div className="row">
                          <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="MobNo" name="MobNo" placeholder="Enter Valid Mobile Number" maxLength={10}/>
                          </div>
                          <div class="col-md-6">
                            <label for="TeacherName" class="form-label">Teacher Name</label>
                            <input type="text" class="form-control" id="TeacherName" name="TeacherName" placeholder="Enter Full Name"/>
                          </div>
                        </div>
                        <div className="row">
                          <div class="col-md-6">
                        ...
                        <div className="row">
                          <div class="col-md-12">
                             <button type="button" class="btn btn-primary" style={{marginTop:"10px"}}>Add Teacher</button>
                          </div>
                        </div>
                      </div>
                    </div>
