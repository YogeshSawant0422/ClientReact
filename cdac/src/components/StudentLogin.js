    ...
    <div className='container'> <br /><br />
     ...
     <br /><br />
      <div className="container" style={{ width: "40%", border: "2px solid #00517B", borderRadius: "10px", padding: "20px" }}>
        <form  >
          <h1 className="text-center" style={{ color: "white", backgroundColor: "#00517B", borderRadius: "10px" }}>Student Login</h1>
          <div className="form-group">
            <label htmlFor="exampleInputEmail1">IACSD Id</label>
            <input
        ...
        <button
          onClick={() => { check() }}
          type="submit" className="btn" style={{color:"white", backgroundColor:"#00517B"}}>Submit</button>
